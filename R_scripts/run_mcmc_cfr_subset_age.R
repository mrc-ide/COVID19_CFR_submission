...
# run_mcmc_cfr_subset_age.R
#
# Author: Bob Verity
# Date: 2020-03-09
#
# Purpose:
# Perform similar analysis as run_mcmc_cfr_all.R, except subsetting to age under
# 60 vs 60 or over.
#
# ------------------------------------------------------------------
...
# subset to ensure age info present
data <- subset(data, !is.na(age_years))
